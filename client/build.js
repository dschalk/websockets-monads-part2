...
exports['default'] = { monad: monad, monadIter: monadIter, steps: steps, next: next, dice: dice, send: send, nex: nex };
...
var newMessage = function newMessage(v, mon) {
  var ar = mM11.x;
  ar.push((0, _snabbdomH2['default'])('div', mM16.x));
  mM11.ret(ar);
  return mon;
};
