...
var next = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '    var next = function next(x,mon,bool,mon2) {  \n      if (bool) {\n        mon2.release();\n      }\n      return mon\n    }');
