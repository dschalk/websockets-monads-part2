...
var pauseDemo = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '  mM1.bnd(pause,4,mMI1)\n    .bnd(() => mMI1\n    .bnd(() => mM2.ret("Hello")\n    .bnd(() => mM3.ret(3)\n    .bnd(mM4.ret)\n    .bnd(cube)\n    .bnd(update))))  ');
...
function updatePauseDemo() {
  mM1.bnd(pause, 4, mMI1).bnd(function () {
    return mMI1.bnd(function () {
      return mM2.ret("Hello").bnd(function () {
        return mM3.ret(3).bnd(mM4.ret).bnd(cube).bnd(update);
      });
    });
  });
}
