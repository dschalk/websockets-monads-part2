...
var messages1 = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '  var updateMessages = function msg(x,mon) {  \n    mon.ret([]);\n    let ar2 = mMmsg.x;\n    let keys = Object.keys(ar2);\n    for (let k in keys) {\n      mon.bnd(push, ar2[k])\n      .bnd(push, h(\'br\'));\n    }\n    return mon;\n  }\n');

var messages2 = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '  case "CD#$42":\n    gameArray.splice(0,3);\n    let message = gameArray.reduce((a,b) => a + ", " + b)  \n    let str = sender + \': \' + message;\n    mMmsg\n    .bnd(push,str)\n    .bnd( () => mMmessage\n    .bnd(updateMessages)\n    .bnd(update) );\n  break;\n');

var messages3 = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '\n');

var messages4 = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '\n');

var messages5 = (0, _snabbdomH2['default'])('pre', { style: { color: '#AFEEEE' } }, '\n');
...
exports['default'] = { monad: monad, monadIter: monadIter, steps: steps, dice: dice, send: send, nex: nex, updateNext: updateNext,
  pause: pause, pauseDemo: pauseDemo, messages1: messages1, messages2: messages2, messages3: messages3 };
...
var updateMessages = function msg(x, mon) {
  ...
  for (var k in keys) {
    mon.bnd(push, ar2[k]).bnd(push, (0, _snabbdomH2['default'])('br'));
  }
  return mon;
};
  ...
  switch (d2) {
    ...
    case "CD#$42":
      ...
      mMmsg.bnd(push, str).bnd(function () {
        return mMmessage.bnd(updateMessages).bnd(update);
      });
      break;
