...
function view(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15, m16, m17, m18, m19, mI1, mI2) { 
  return h('div',{style: style3}, 
   ...
   h('button', {on: { mouseenter: update4e, mouseleave: update4l, click: updatePauseDemo }, style: style4},
      ...
      cow.messages2, 
      h('p', 'When a chat message comes in, mMmsg updating itself with the new message and then hands over processing to mMmessage. mMmessage then calls updateChildren with its bnd method, designating mMmsg as the text source, and then calls .bnd(update). That\'s all there is to it. The array mMmessage.x sits quietly in view() as an array of children of its parent div. '  ),
      h('p', 'Similarly, the score board is updated by: '  ),
      cow.messages3,
